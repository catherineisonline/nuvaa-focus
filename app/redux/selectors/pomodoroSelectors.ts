...
export const selectPomodoroCount = (state: RootState) => state.pomodoro.pomodoroCount;
...
export const selectCurrentMode = (state: RootState) => state.pomodoro.currentMode;
