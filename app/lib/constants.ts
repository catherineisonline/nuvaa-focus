...
export const ONBOARDING_STEPS = [
  {
    ...
    content:
      "Your cozy ADHD-friendly focus timer designed to help you focus with comfort and ease.",
  },
  {
    icon: BookOpenCheck,
    title: "Pick a Task",
    content:
      "Start by adding tasks to your list. Choose one to focus on during your session.",
  },
  {
    icon: Hourglass,
    title: "Start Your Timer",
    content:
      "Begin with a 25-minute focus session. The timer will guide you through work and break periods.",
  },
  {
    icon: BicepsFlexed,
    title: "Work Distraction-Free",
    content:
      "Focus completely on your chosen task. Avoid distractions and interruptions during this time.",
  },
  {
    icon: Repeat,
    title: "Take Breaks & Repeat",
    content:
      "Enjoy 5-minute breaks between sessions. After 4 focus sessions, take a longer 15-30 minute break.",
  },
];
